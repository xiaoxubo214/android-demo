...
public class ServerException extends RuntimeException {
    ...
    public static final int MSG_NULL_VALUE = 200001;//Null 错误
    ...
    public static final int MSG_COURSE_NO_SIGN = 200002;    //该课程已经销课无法签到
    public static final int MSG_ERROR_TIME_MULTi = 200003;  //老师排课时间存在冲突！

    private static String message;
    public static int errorCode;

    public ServerException(String resultCode, String message) {
