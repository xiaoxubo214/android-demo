...
import com.by.wind.demo.activity.ActivityLifeCycleEvent;
...
public abstract class BaseFragment extends Fragment {
    ...
    protected boolean requestPermission(String permission, int requestCode) {
        ...
        if (grant == PackageManager.PERMISSION_GRANTED) {
            ...
            boolean rationale = ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), permission);
            if (!rationale) {
                ToastUtil.show("读取相册失败,权限被拒绝");
            }
