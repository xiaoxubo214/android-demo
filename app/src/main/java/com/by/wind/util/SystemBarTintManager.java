...
public class SystemBarTintManager {
    ...
    public static class SystemBarConfig {
         ...
         * device configuration? A navigation bar may appear ic_on the right side of
        ...
        /**
         * Get the width of the system navigation bar when it is placed vertically ic_on the screen.
         *
